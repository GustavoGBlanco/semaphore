...
Este proyecto fue desarrollado con .NET 9 y contiene múltiples ejemplos prácticos del uso de `Semaphore` para sincronización multihilo. A continuación, se detallan los pasos para compilar y ejecutar correctamente la solución.
...
1. **Abrí Visual Studio**  
   Seleccioná *“Abrir un proyecto o solución”* y abrí `SemaphoreExamples.csproj`.
...
- `SemaphoreExamples.cs`: contiene la lógica de sincronización.
...
A continuación se incluye una captura de pantalla con los resultados en consola al ejecutar el proyecto. Esto es útil para visualizar rápidamente el comportamiento de los hilos y la sincronización con `Semaphore`.
